...
#The parts of Time Series was inspired by TaoTaoSun
...
plot(BaoAn_data_tbl$Obs_Time, BaoAn_data_tbl$BaoAn_T_value2, 
     lwd=0.5, type="l", col="blue")
#examine the min and max
min(BaoAn_data_tbl$BaoAn_T_value2, na.rm=T) #1.8
max(BaoAn_data_tbl$BaoAn_T_value2, na.rm=T) #3.8
...
#-------------------------------------------------
#2.1 Construct a time series of monthly-averaged temperature 
#from 2010 Jan. to 2020 Aug.
#-------------------------------------------------
...
arima2
#----------------------------------------------------------------
#2.4 [5 points] Predict monthly-averaged temperatures in 2020 Sep. 
#and Oct. with the ARIMA model from 2.3. 
#The predictions will be evaluated against actual observations 
#in those two months.
#----------------------------------------------------------------
